...
//  Messenger
//
//  Created by Jaideep Singh on 16/10/23.
//
...
enum MessageDefaults {
    ...
    static let bubbleColorIncoming = UIColor(named: "chatIncomingBubble") ?? UIColor(red: 230/255, green: 229/255, blue: 255/255, alpha: 1.0)
}
